...
export default function Home() {
  return <main>
    ...
    <section className="closing"><div className="closing-image"><img src="/ceremony-invitation.jpg" alt="Floral wedding ceremony invitation" /></div><div className="closing-copy"><p className="eyebrow">A gentle reminder</p><h2>Your presence will make our day <em>complete.</em></h2><p>We cannot wait to welcome you and celebrate the beginning of our forever.</p><a className="button" href="#top">Back to top <span>↑</span></a></div></section>
